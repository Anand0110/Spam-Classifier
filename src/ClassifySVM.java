...
public class ClassifySVM extends JFrame {
...
//                                obj.show();
//                                
//                                ClassifySVM obj1 = new ClassifySVM();
//                                obj1.hide();
////                               
//			}
//		});
...
//            @Override
//            public void run() {
//                new ClassifySVM().setVisible(true);
//            }
//        });
//    }
//}
...
//
    ...
    public ClassifySVM(String nameOfFile) {
        super("Test...");
...
//		});
    ...
    public void printLog(String finalname) {
        String[] finalnamearray = new String[1];
        finalnamearray[0] = finalname;
        Thread thread1 = new Thread(new Runnable() {
            @Override
            public void run() {
				//while (true) {
			...
			public void actionPerformed(ActionEvent evt) {
				//TextAreaLogProgram obj = new TextAreaLogProgram();
                                ...
                                ClassifySVM obj1 = new ClassifySVM(null);
                                obj1.hide();
//                               
			}
		});
...
//					}
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ClassifySVM(null).setVisible(true);
            }
        });
    }
}
